...
var IMG_DIR = "www/app/assets/"

/******************************************************************************
 * watch
 * Build the app and watch for source file changes.
 ******************************************************************************/
gulp.task('watch', ['sass', 'copy.fonts', 'copy.images', 'copy.html'], function(done) {
 ...
 ******************************************************************************/
gulp.task('build', ['sass', 'copy.fonts', 'copy.images', 'copy.html'], function(done) {
  bundle(false, done);
});
...
gulp.task('sass', function(){
  ...
  return gulp.src('www/app/app.+(ios|md).scss')
    .pipe(sass({
      includePaths: [
        IONIC_DIR,
...
gulp.task('copy.images', function() {
  return gulp.src(IMG_DIR + '**/*.+(jpg|jpeg|png|gif)')
